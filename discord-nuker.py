...
#NUKE CONFIG
spam_messages = ["@everyone Raided by teamfox", "@everyone DONT CRY KIDS"]
channel_names = ["TEAMFOX", "TEAMFOX"]
...
```
Made by Lorfly.
https://github.com/lorfly4/DiscordNuker
```
""")
...
async def nuke(guild):
  ...
  for member in guild.members:
    try:
      ...
      print(f"{C.WHITE}{member.name} {C.RED}has been banned.")
  for i in range(500):
